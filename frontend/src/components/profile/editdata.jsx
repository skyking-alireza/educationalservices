    ...
    return(
        <section className={'w-full justify-between h-full flex'}>
            ...
            <img className={'h-screen w-screen object-cover brightness-50 left-0'}
                 src={'images/signup/close-up-doctor-filling-out-prescription.webp'} alt={'signup'}/>
                ...
                <div className={'max-w-[400px] mx-auto py-16 bg-black/70 text-center text-white rounded-3xl'}>
                    ...
                    <form name={'register'} className={'py-5 flex flex-col '} id={'createform'}>
                        <div className={'max-h-[330px] h-[330px] overflow-y-scroll overflow-x-hidden'}>
                            <label>
                                <input type={'text'} id={'firstname'} minLength={3} required={true}
                            ...
                            <label>
                                <input type={'text'} id={'lastname'} min={3} required={true}
                            ...
                            <label>
                                <input type={'text'} id={'fathername'} min={3} required={true}
                                       className={'rounded-md peer mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                            ...
                            <label>
                                <IMaskInput id={'phonenumber'} minLength={10}
                                            onChange={(e) => setUsername(e.target.value)} required={true} type={'text'}
                                            className={'rounded-md peer mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                                            name={'phonenumber'} mask={'9000000000'} placeholder={'شماره تماس'}/>
                            ...
                            <IMaskInput type={'hidden'} value={username}
                            ...
                            <label>
                                <IMaskInput id={'virtualnumber'} minLength={10} required={true} type={'text'}
                                            className={'rounded-md peer mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                            ...
                            <label>
                                <IMaskInput id={'studentcode'} minLength={14} required={true} type={'text'}
                                            className={'rounded-md peer mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                            ...
                            <label>
                                <textarea id={"address"} required={true}
                                          className={'rounded-md mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                            ...
                            <label>
                                <textarea required={true} id={'Skill'}
                                          className={'rounded-md peer mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                                          name={'Skill'} placeholder={'مهارت های تخصصی مرتبط با رشته'}></textarea>
                            ...
                            <br/>
                            <input id={'enable'} name={'jointype'}
                                   className={'accent-blue-600 cursor-pointer w-5 h-5 rounded-xl duration-300'}
                                   value={1} type={'radio'}/>
                            <label htmlFor={'enable'}>فعال</label>
                            <input checked={true} id={'disable'} name={'jointype'}
                                   className={'accent-blue-600 cursor-pointer w-5 h-5 rounded-xl duration-300'}
                                   value={0} type={'radio'}/>
                            <label htmlFor={'disable'}>عادی</label>
                            <input required={true} placeholder={'رمز عبور'} type={'password'}
                                   onChange={(e) => setPassword(e.target.value)}
                                   className={'rounded-md mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                                   name={'password'}/>
                            <input required={true} placeholder={'تکرار رمز عبور'} type={'password'}
                                   onChange={(e) => setRepeat_password(e.target.value)}
                                   className={'rounded-md mx-20 bg-gray-600 my-2 invalid:outline-none invalid:ring invalid:ring-red-600 valid:outline-none valid:ring valid:ring-green-600 focus:outline-none focus:ring focus:ring-blue-600 p-3'}
                                   name={'repeat_password'}/>
                            <p className={password === repeat_password ? 'hidden' : 'text-red-700'}>پسورد ها برابر
                                نیستند</p>
                            <br/>
                        </div>
                        <input type={'button'} onClick={create_user}
