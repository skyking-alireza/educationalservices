  ...
  return(
      <section className={'w-full h-full flex'} >
          <div className={'absolute top-[55%] w-full text-center '}>
              <button className={'px-9 py-4 rounded-2xl text-white text-3xl bg-teal-500 inline-flex hover:bg-transparent duration-500 border-teal-500 border-2 hover:text-teal-500'}>لیست دوره ها<BsArrowLeftSquareFill className={'pr-2 w-9 h-9 '}/></button>
          </div>
